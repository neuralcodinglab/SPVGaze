...
{
    public class RunExperiment_exp1 : MonoBehaviour
    {
        ...
        public static RunExperiment_exp1 Instance { get; private set; }
        ...
        private void StartNewTrial()
        {
            ...
            // update UI
            SingletonRegister.GetInstance<UICallbacks_exp1>().UpdateBlockAndTrial(currBlock + 1, currTrial + 1);
            ...
            SingletonRegister.GetInstance<InputHandler>().MoveToNewHallway(HallwayCreator.HallwayObjects[hallway]);
        ...
        {
            SingletonRegister.GetInstance<UICallbacks_exp1>().BtnPlayground();
            // SenorSummarySingletons.GetInstance<PhospheneSimulator>().StopTrial();
            SingletonRegister.GetInstance<UICallbacks>().PostBlock(allHandlers);
        }
